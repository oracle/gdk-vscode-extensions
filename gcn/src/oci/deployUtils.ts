...
export async function deployFolders(folders: vscode.WorkspaceFolder[], resourcesPath: string, saveConfig: SaveConfig, dump: DumpDeployData): Promise<undefined> {
    ...
    const deployData: any = dump(null) || { repositories: {} };
    ...
    if (deployData.project) {
        try {
            selectedName = (await ociUtils.getDevopsProject(provider, deployData.project)).name;
            if (!selectedName) {
        ...
        return new Promise(async resolve => {
            ...
            if (deployData.projectLogWorkRequest) {
                ...
                try {
                    ...
                    deployData.projectLogWorkRequest = await ociUtils.createProjectLog(provider, deployData.compartment.ocid, deployData.logGroup, deployData.project, projectName);
                } catch (err) {
            ...
            if (deployData.artifactsRepository) {
                progress.report({
                    message: `Using already created artifact repository...`
                });
                try {
            ...
            if (deployData.okeCluster) {
                if (deployData.okeClusterEnvironment) {
                    progress.report({
                        message: `Using already created OKE cluster environment...`
                    });
                    try {
            ...
            if (deployData.knowledgeBaseWorkRequest) {
                progress.report({
                    message: `Using already created ADM knowledge base...`
                });
                try {
            ...
            for (const folder of projectFolders) {
                ...
                if (!folderData) {
                    folderData = deployData.repositories[repositoryName] = { subs: {} };
                }
                ...
                if (folderData.codeRepository) {
                    ...
                    try {
                        ...
                        const repo = await ociUtils.createCodeRepository(provider, deployData.project, repositoryName, 'master', description);
                ...
                if (project_devbuild_artifact_location && project_devbuild_command) {
                    ...
                    if (folderData.devbuildArtifact) {
                        ...
                        try {
                            ...
                            folderData.devbuildArtifact = (await ociUtils.createProjectDevArtifact(provider, deployData.artifactsRepository, deployData.project, devbuildArtifactPath, devbuildArtifactName, devbuildArtifactDescription)).id;
                        } catch (err) {
                    ...
                    if (folderData.devbuildPipeline) {
                        ...
                        try {
                            ...
                            folderData.devbuildPipeline = (await ociUtils.createBuildPipeline(provider, deployData.project, devbuildPipelineName, devbuildPipelineDescription)).id;
                        } catch (err) {
                    ...
                    if (folderData.devbuildPipelineBuildStage) {
                        ...
                        try {
                            ...
                            folderData.devbuildPipelineBuildStage = (await ociUtils.createBuildPipelineBuildStage(provider, folderData.devbuildPipeline, codeRepository.id, repositoryName, codeRepository.httpUrl, `.gcn/${devbuildspec_template}`)).id;
                        } catch (err) {
                    ...
                    if (folderData.devbuildPipelineArtifactsStage) {
                        ...
                        try {
                            ...
                            folderData.devbuildPipelineArtifactsStage = (await ociUtils.createBuildPipelineArtifactsStage(provider, folderData.devbuildPipeline, folderData.devbuildPipelineBuildStage, folderData.devbuildArtifact, devbuildArtifactName)).id;
                        } catch (err) {
                ...
                if (project_native_executable_artifact_location && project_build_native_executable_command) {
                    ...
                    if (folderData.nibuildArtifact) {
                        ...
                        try {
                            ...
                            folderData.nibuildArtifact = (await ociUtils.createProjectDevArtifact(provider, deployData.artifactsRepository, deployData.project, nibuildArtifactPath, nibuildArtifactName, nibuildArtifactDescription)).id;
                        } catch (err) {
                    ...
                    if (folderData.nibuildPipeline) {
                        ...
                        try {
                            ...
                            folderData.nibuildPipeline = (await ociUtils.createBuildPipeline(provider, deployData.project, nibuildPipelineName, nibuildPipelineDescription)).id;
                        } catch (err) {
                    ...
                    if (folderData.nibuildPipelineBuildStage) {
                        ...
                        try {
                            ...
                            folderData.nibuildPipelineBuildStage = (await ociUtils.createBuildPipelineBuildStage(provider, folderData.nibuildPipeline, codeRepository.id, repositoryName, codeRepository.httpUrl, `.gcn/${nibuildspec_template}`)).id;
                        } catch (err) {
                    ...
                    if (folderData.nibuildPipelineArtifactsStage) {
                        ...
                        try {
                            ...
                            folderData.nibuildPipelineArtifactsStage = (await ociUtils.createBuildPipelineArtifactsStage(provider, folderData.nibuildPipeline, folderData.nibuildPipelineBuildStage, folderData.nibuildArtifact, nibuildArtifactName)).id;
                        } catch (err) {
                            ...
                            if (project_native_executable_artifact_location && project_build_native_executable_command) {
                                ...
                                if (subData.docker_nibuildArtifact) {
                                    ...
                                    try {
                                        ...
                                        subData.docker_nibuildArtifact = (await ociUtils.createProjectDockerArtifact(provider, deployData.project, docker_nibuildImage, docker_nibuildArtifactName, docker_nibuildArtifactDescription)).id;
                                    } catch (err) {
                                ...
                                if (subData.docker_nibuildPipeline) {
                                    ...
                                    try {
                                        ...
                                        subData.docker_nibuildPipeline = (await ociUtils.createBuildPipeline(provider, deployData.project, docker_nibuildPipelineName, docker_nibuildPipelineDescription, {
                                ...
                                if (subData.docker_nibuildPipelineBuildStage) {
                                    ...
                                    try {
                                        ...
                                        subData.docker_nibuildPipelineBuildStage = (await ociUtils.createBuildPipelineBuildStage(provider, subData.docker_nibuildPipeline, codeRepository.id, repositoryName, codeRepository.httpUrl, `.gcn/${subName}_${docker_nibuildspec_template}`)).id;
                                    } catch (err) {
                                ...
                                if (subData.docker_nibuildPipelineArtifactsStage) {
                                    ...
                                    try {
                                        ...
                                        subData.docker_nibuildPipelineArtifactsStage = (await ociUtils.createBuildPipelineArtifactsStage(provider, subData.docker_nibuildPipeline, subData.docker_nibuildPipelineBuildStage, subData.docker_nibuildArtifact, docker_nibuildArtifactName)).id;
                                    } catch (err) {
                                ...
                                if (subName === 'oci') {
                                    ...
                                    if (subData.oke_deployConfigArtifact) {
                                        ...
                                        try {
                                            ...
                                            subData.oke_deployConfigArtifact = (await ociUtils.createOkeDeployConfigurationArtifact(provider, deployData.project, oke_deployConfigInlineContent, oke_deployConfigArtifactName, oke_deployConfigArtifactDescription)).id;
                                        } catch (err) {
                                    ...
                                    if (deployData.okeClusterEnvironment) {
                                        ...
                                        if (subData.oke_deployPipeline) {
                                            ...
                                            try {
                                                ...
                                                subData.oke_deployPipeline = (await ociUtils.createDeployPipeline(provider, deployData.project, oke_deployPipelineName, oke_deployPipelineDescription, [{
                                                    name: 'DOCKER_TAG',
                                                    defaultValue: 'latest'
                                                }], {
                                        ...
                                        if (subData.deployToOkeStage) {
                                            ...
                                            try {
                                                ...
                                                subData.deployToOkeStage = (await ociUtils.createDeployToOkeStage(provider, subData.oke_deployPipeline, deployData.okeClusterEnvironment, subData.oke_deployConfigArtifact)).id;
                                            } catch (err) {
                    ...
                    if (project_native_executable_artifact_location && project_build_native_executable_command) {
                        ...
                        if (folderData.docker_nibuildArtifact) {
                            ...
                            try {
                                ...
                                folderData.docker_nibuildArtifact = (await ociUtils.createProjectDockerArtifact(provider, deployData.project, docker_nibuildImage, docker_nibuildArtifactName, docker_nibuildArtifactDescription)).id;
                            } catch (err) {
                        ...
                        if (folderData.docker_nibuildPipeline) {
                            ...
                            try {
                                ...
                                folderData.docker_nibuildPipeline = (await ociUtils.createBuildPipeline(provider, deployData.project, docker_nibuildPipelineName, docker_nibuildPipelineDescription, {
                        ...
                        if (folderData.docker_nibuildPipelineBuildStage) {
                            ...
                            try {
                                ...
                                folderData.docker_nibuildPipelineBuildStage = (await ociUtils.createBuildPipelineBuildStage(provider, folderData.docker_nibuildPipeline, codeRepository.id, repositoryName, codeRepository.httpUrl, `.gcn/${docker_nibuildspec_template}`)).id;
                            } catch (err) {
                        ...
                        if (folderData.docker_nibuildPipelineArtifactsStage) {
                            ...
                            try {
                                ...
                                folderData.docker_nibuildPipelineArtifactsStage = (await ociUtils.createBuildPipelineArtifactsStage(provider, folderData.docker_nibuildPipeline, folderData.docker_nibuildPipelineBuildStage, folderData.docker_nibuildArtifact, docker_nibuildArtifactName)).id;
                            } catch (err) {
                        ...
                        if (folderData.oke_deployConfigArtifact) {
                            ...
                            try {
                                ...
                                folderData.oke_deployConfigArtifact = (await ociUtils.createOkeDeployConfigurationArtifact(provider, deployData.project, oke_deployConfigInlineContent, oke_deployConfigArtifactName, oke_deployConfigArtifactDescription)).id;
                            } catch (err) {
                        ...
                        if (deployData.okeClusterEnvironment) {
                            ...
                            if (folderData.oke_deployPipeline) {
                                ...
                                try {
                                    ...
                                    folderData.oke_deployPipeline = (await ociUtils.createDeployPipeline(provider, deployData.project, oke_deployPipelineName, oke_deployPipelineDescription, [{
                                        name: 'DOCKER_TAG',
                                        defaultValue: 'latest'
                                    }], {
                            ...
                            if (folderData.deployToOkeStage) {
                                ...
                                try {
                                    ...
                                    folderData.deployToOkeStage = (await ociUtils.createDeployToOkeStage(provider, folderData.oke_deployPipeline, deployData.okeClusterEnvironment, folderData.oke_deployConfigArtifact)).id;
                                } catch (err) {
